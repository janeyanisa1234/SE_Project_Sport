          ...
          promotedStadiums
            ...
            .map((place, index) => (
              <div key={place.id || index} className="place-card">
                {/* ลิงก์รูปภาพไปหน้า Select-nologin */}
                <Link
                  href={`/Search-nologin/Select-nologin?stadium_name=${encodeURIComponent(place.stadium_name)}&stadium_address=${encodeURIComponent(place.stadium_address)}`}
                >
                  <img
                ...
                <div className="place-info">
                  {/* ลิงก์ชื่อสนามไปหน้า Select-nologin */}
                  <Link
                    href={`/Search-nologin/Select-nologin?stadium_name=${encodeURIComponent(place.stadium_name)}&stadium_address=${encodeURIComponent(place.stadium_address)}`}
                  >
